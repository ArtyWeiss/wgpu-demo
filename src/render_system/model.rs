...
pub trait DrawModel<'a> {
    ...
    fn draw_character(
        ...
        camera_bind_group: &'a wgpu::BindGroup,
        light_bind_group: &'a wgpu::BindGroup,
        character_bind_group: &'a wgpu::BindGroup,
    );
}
        ...
        'b: 'a,
{
    ...
    fn draw_character(&mut self, model: &'b Model, camera_bind_group: &'b wgpu::BindGroup, light_bind_group: &'b wgpu::BindGroup, character_bind_group: &'b wgpu::BindGroup) {
        for mesh in &model.meshes{
            let material = &model.materials[mesh.material];
            self.set_vertex_buffer(0, mesh.vertex_buffer.slice(..));
            self.set_index_buffer(mesh.index_buffer.slice(..), wgpu::IndexFormat::Uint32);
            ...
            self.set_bind_group(1, camera_bind_group, &[]);
            self.set_bind_group(2, light_bind_group, &[]);
            self.set_bind_group(3, character_bind_group, &[]);
